...
> `git@github.com:1an3r/kickstart.nvim.git`
...
```sh
git clone git@github.com:1an3r/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone git@github.com:1an3r/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone git@github.com:1an3r/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
